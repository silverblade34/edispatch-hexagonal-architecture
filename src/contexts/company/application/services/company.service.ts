...
export class CompanyService {
    ...
    private async mapCompanyWithUser(company: Company): Promise<ResponseCompanyDto> {
    ...
    async findAllCompany(): Promise<ResponseCompanyDto[]> {
    ...
    async updateCompany(
        ...
        const master = await this.companyRepository.findById(companyId);
        if (!master) {
